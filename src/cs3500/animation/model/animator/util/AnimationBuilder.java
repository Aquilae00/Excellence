...
/**
 * AnimationBuilder interface that provides methods for usage.
 *
 * @param <Doc> document
 */
public interface AnimationBuilder<Doc> {
  ...
  /**
   * Adds a transformation to the growing document. Constraints: none of the motions described can
   * overlap, and any adjacent motions must agree on their common endpoint: shapes can’t “teleport”
   * unless we explicitly tell them to.
   *
  ...
  AnimationBuilder<Doc> addRotation(String name,
